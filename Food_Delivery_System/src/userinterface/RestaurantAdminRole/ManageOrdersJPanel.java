...
//        btnAssign.setEnabled(false);
    ...
    private void btnAcceptOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcceptOrderActionPerformed
        ...
        if(selectedRow >= 0)
        {
            ...
            {
                System.out.println("workrequest: " + wr.getOrder().getOrderId());
                if(wr.getOrder().getOrderId() == orderId && wr.getStatus().equalsIgnoreCase("Assinged to delivery Man"))
                {
                        JOptionPane.showMessageDialog(null, "The order is already assigned for delivery");
                }
                else if(wr.getOrder().getOrderId() == orderId && wr.getStatus().equalsIgnoreCase("Declined"))
                {
                      JOptionPane.showMessageDialog(null, "The order is already declined."); 
                }
                else if(wr.getOrder().getOrderId() == orderId && wr.getStatus().equalsIgnoreCase("Delivered"))
                {
                      JOptionPane.showMessageDialog(null, "The order is already delivered."); 
                }
                else if(wr.getOrder().getOrderId() == orderId && wr.getStatus().equalsIgnoreCase("Out for Delivery"))
                {
                      JOptionPane.showMessageDialog(null, "The order is out for delivery."); 
                }
                else if(wr.getOrder().getOrderId() == orderId && wr.getStatus().equalsIgnoreCase("Accepted"))
                {
                    JOptionPane.showMessageDialog(null, "The order is already accepted."); 
                }
                else if(wr.getOrder().getOrderId() == orderId && wr.getStatus().equalsIgnoreCase("Order Placed/Sent"))
                {
           ...
           for(WorkRequest wr: this.restaurant.getWorkQueue().getWorkRequestList())
            {
                ...
                else if(wr.getOrder().getOrderId() == orderId && wr.getStatus().equalsIgnoreCase("Order Placed/Sent"))
                {
                    ...
                    JOptionPane.showMessageDialog(null, "The order has been declined.");
                    this.populateTable();
